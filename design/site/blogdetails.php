...
<html lang="en">
  <head>
    ...
    <!-- Styles -->
    <link href="design/site/assets/css/core.min.css" rel="stylesheet">
    <link href="design/site/assets/css/thesaas.min.css" rel="stylesheet">
    <link href="design/site/assets/css/style.css" rel="stylesheet">

    <!-- Favicons -->
    <link rel="apple-touch-icon" href="design/site/assets/img/apple-touch-icon.png">
    <link rel="icon" href="design/site/assets/img/favicon.png">
  </head>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="topbar-left">
          ...
          <a class="topbar-brand" href="index.html">
            <img class="logo-default" src="design/site/assets/img/logo.png" alt="logo">
            <img class="logo-inverse" src="design/site/assets/img/logo-light.png" alt="logo">
          </a>
        </div>
    ...
    <!-- Header -->
    <header class="header header-inverse h-fullscreen pb-80" style="background-image: url(design/site/assets/img/bg-cup.jpg);" data-overlay="8">
      <div class="container text-center">
        ...
        <div class="row h-full">
          <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
            ...
            <br>
            <h1 class="display-4 hidden-sm-down"><?= $blog['title']; ?></h1>

            <br><br>
            <p><span class="opacity-70 mr-8">By</span> <a class="text-white" href="#">Hossein Shams</a></p>
            <p><img class="rounded-circle w-40" src="design/site/assets/img/avatar/2.jpg" alt="..."></p>
          ...
          <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
              ...
              <div id="media-list" class="media-list">
                ...
                <div class="media">
                  <img class="rounded-circle w-40" src="design/site/assets/img/avatar/1.jpg" alt="...">
              ...
              <!-- <form action="#" method="POST"> -->
                ...
                <input id="blog_id" type="hidden" value="<?=$id; ?>" class="form-control" type="text" placeholder="Email">
        ...
        <div class="row gap-y align-items-center">
          <div class="col-12 col-lg-3">
            <p class="text-center text-lg-left">
              <a href="index.html"><img src="design/site/assets/img/logo.png" alt="logo"></a>
            </p>
          </div>
    ...
    <!-- Scripts -->
    <script src="design/site/assets/js/core.min.js"></script>
    <script src="design/site/assets/js/thesaas.min.js"></script>
    <script src="design/site/assets/js/script.js"></script>
    <script>
